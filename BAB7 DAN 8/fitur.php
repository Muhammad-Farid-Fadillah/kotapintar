...
<head>
    ...
    <meta name="description" content="Kota Pintar - Fitur Unggulan untuk Membuat Kota Anda Lebih Cerdas dan Terhubung.">
    <meta name="keywords" content="Kota Pintar, Smart City, Peta Interaktif, Transportasi, Manajemen Sampah, Energi, Partisipasi Warga">
    ...
    <style>
        ...
        * {
        ...
        /* Hover Effect on Feature Cards (Interactive Demo) */
        .feature-card[data-modal="true"]:hover {
...
<body>
    ...
    <main>
        ...
        <div class="features">
            <!-- Feature Cards -->
            <div class="feature-card" data-modal="true" onclick="alert('Peta Interaktif akan muncul disini!')">
                <i class="fas fa-map-marked-alt"></i>
                <h3>Peta Interaktif</h3>
                <p>Memudahkan pencarian lokasi penting seperti fasilitas kesehatan, transportasi, dan area publik.</p>
            </div>
            <div class="feature-card" data-modal="true" onclick="alert('Smart Transport info real-time transportasi!')">
                <i class="fas fa-bus"></i>
                <h3>Smart Transport</h3>
                <p>Sistem informasi transportasi real-time untuk mengatur perjalanan Anda dengan efisien.</p>
            </div>
            <div class="feature-card" data-modal="true" onclick="alert('Manajemen Sampah detail akan ditampilkan di sini!')">
                <i class="fas fa-trash-alt"></i>
                <h3>Manajemen Sampah</h3>
                <p>Pantau jadwal pengumpulan sampah dan pelaporan masalah kebersihan kota.</p>
            </div>
            <div class="feature-card" data-modal="true" onclick="alert('Efisiensi Energi pengelolaan energi akan dijelaskan lebih lanjut!')">
                <i class="fas fa-lightbulb"></i>
                <h3>Efisiensi Energi</h3>
                <p>Sistem pengelolaan energi untuk mengurangi konsumsi dan meningkatkan keberlanjutan.</p>
            </div>
            <div class="feature-card" data-modal="true" onclick="alert('Partisipasi Warga akan melibatkan masyarakat untuk berkontribusi lebih!')">
